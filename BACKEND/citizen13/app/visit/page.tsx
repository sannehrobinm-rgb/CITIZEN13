  ...
  return (
    <div style={{ background: C.light, borderRadius: "12px", padding: compact ? "12px" : "16px", border: `1px solid ${C.border}` }}>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "10px", flexWrap: "wrap" }}>
        ...
        {text.trim() && !recording && (
          <button onClick={confirm} style={{ padding: "8px 16px", borderRadius: "8px", border: "none", cursor: "pointer", fontWeight: "600", fontSize: "13px", background: C.g4, color: "white" }}>
...
export default function Visit() {
  ...
  // ── renderContent : contenu selon la vue active ──────────────────────────
  const renderContent = () => {
    ...
    if (view === "boitage") return (
      <div style={pageStyle}>
        ...
        <div style={content}>
          ...
          {!bShow ? (
            <button onClick={() => setBShow(true)} style={{ width: "100%", padding: "15px", background: GRADIENT, color: "white", border: "none", borderRadius: "12px", cursor: "pointer", fontWeight: "700", fontSize: "15px", marginBottom: "16px" }}>➕ Nouveau boîtage</button>
          ) : (
            <div style={card}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div><label style={lbl}>Adresse exacte</label><input style={inp} value={bForm.adresse} onChange={e => setBForm({ ...bForm, adresse: e.target.value })} /></div>
                ...
                <div><label style={lbl}>Commentaire</label><textarea style={{ ...inp, resize: "vertical", minHeight: "70px" }} value={bForm.commentaire} onChange={e => setBForm({ ...bForm, commentaire: e.target.value })} /></div>
    ...
    if (view === "tractage") return (
      <div style={pageStyle}>
        ...
        <div style={content}>
          ...
          {!tShow ? (
            <button onClick={() => setTShow(true)} style={{ width: "100%", padding: "15px", background: `linear-gradient(135deg, #c97a00, #e67e22)`, color: "white", border: "none", borderRadius: "12px", cursor: "pointer", fontWeight: "700", fontSize: "15px", marginBottom: "16px" }}>➕ Nouveau tractage</button>
          ) : (
            <div style={card}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div><label style={lbl}>Adresse exacte</label><input style={inp} value={tForm.adresse} onChange={e => setTForm({ ...tForm, adresse: e.target.value })} /></div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
                ...
                <div><label style={lbl}>Commentaire</label><textarea style={{ ...inp, resize: "vertical", minHeight: "70px" }} value={tForm.commentaire} onChange={e => setTForm({ ...tForm, commentaire: e.target.value })} /></div>
                <div style={{ display: "flex", gap: "8px" }}>
  ...
  // ── Return principal — ProtectedRoute enveloppe tout le contenu ──────────
  return (
    <ProtectedRoute>
      {renderContent()}
    </ProtectedRoute>
